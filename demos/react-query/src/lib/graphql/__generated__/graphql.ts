...
export const useGetNinjaTurtlesWithCommentsQuery = <
    ...
    >(
      ...
      options?: Omit<UseQueryOptions<GetNinjaTurtlesWithCommentsQuery, TError, TData>, 'queryKey'> & { queryKey?: UseQueryOptions<GetNinjaTurtlesWithCommentsQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useQuery<GetNinjaTurtlesWithCommentsQuery, TError, TData>(
      {
    queryKey: variables === undefined ? ['GetNinjaTurtlesWithComments'] : ['GetNinjaTurtlesWithComments', variables],
    queryFn: useAuthenticatedFetcher<GetNinjaTurtlesWithCommentsQuery, GetNinjaTurtlesWithCommentsQueryVariables>(GetNinjaTurtlesWithCommentsDocument).bind(null, variables),
    ...options
  }
    )};

useGetNinjaTurtlesWithCommentsQuery.getKey = (variables?: GetNinjaTurtlesWithCommentsQueryVariables) => variables === undefined ? ['GetNinjaTurtlesWithComments'] : ['GetNinjaTurtlesWithComments', variables];
...
export const useAddCommentMutation = <
    ...
    mutationFn: useAuthenticatedFetcher<AddCommentMutation, AddCommentMutationVariables>(AddCommentDocument),
    ...options
  }
    )};
