...
| Parameter | Type                                           | Description                                        |
| --------- | ---------------------------------------------- | -------------------------------------------------- |
| `storage` | [`SessionStorage`](index#sessionstorage-1) | Storage implementation for retrieving session data |
...
| `storage`                | [`SessionStorage`](index#sessionstorage-1) | Storage implementation for persisting session data                                    |
