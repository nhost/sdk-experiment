...
| -------------- | --------------------------------------- |
| `T`            | -                                       |
| `V`            | [`GraphQLVariables`](#graphqlvariables) |

###### Parameters

| Parameter    | Type                                | Description                                                 |
| ------------ | ----------------------------------- | ----------------------------------------------------------- |
| `document`   | `TypedDocumentNode`&lt;`T`, `V`&gt; | TypedDocumentNode containing the query and type information |
| `variables?` | `V`                                 | Variables for the GraphQL operation                         |
| `options?`   | `RequestInit`                       | Additional fetch options to apply to the request            |
