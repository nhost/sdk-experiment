...
`Promise`&lt;[`FetchResponse`](fetch#fetchresponse)&lt;[`GraphQLResponse`](#graphqlresponse)&lt;`T`&gt;&gt;&gt;
...
post<T>(
   ...
   options?: RequestInit): Promise<FetchResponse<GraphQLResponse<T>>>;
```
...
| Parameter    | Type                                                                    | Description                                                 |
| ------------ | ----------------------------------------------------------------------- | ----------------------------------------------------------- |
| `document`   | `TypedDocumentNode`&lt;`T`, [`GraphQLVariables`](#graphqlvariables)&gt; | TypedDocumentNode containing the query and type information |
| `variables?` | [`GraphQLVariables`](#graphqlvariables)                                 | Variables for the GraphQL operation                         |
| `options?`   | `RequestInit`                                                           | Additional fetch options to apply to the request            |
