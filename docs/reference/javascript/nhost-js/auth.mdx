...
| <a id="pushchainfunction"></a> `pushChainFunction`             | (`chainFunction`: `ChainFunction`) => `void`                                                                                                                                                                                                      | Add a middleware function to the request chain                                                   |
...
| Parameter    | Type                                              | Description                                        |
| ------------ | ------------------------------------------------- | -------------------------------------------------- |
| `authClient` | [`AuthClient`](#authclient)                       | Auth API client for token refresh operations       |
