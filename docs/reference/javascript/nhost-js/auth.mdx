...
`Promise`&lt;[`FetchResponse`](#fetchresponse)&lt;[`CreatePATResponse`](#createpatresponse)&gt;&gt;
...
`Promise`&lt;[`FetchResponse`](#fetchresponse)&lt;[`SignInOTPEmailVerifyResponse`](#signinotpemailverifyresponse)&gt;&gt;
