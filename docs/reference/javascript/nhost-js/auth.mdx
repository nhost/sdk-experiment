...
changeUserEmail: (
  ...
  options?: RequestInit,
) => Promise<FetchResponse<"OK" | ErrorResponse>>;
```
...
`Promise`&lt;[`FetchResponse`](#fetchresponse)&lt;`"OK"` \| [`ErrorResponse`](#errorresponse)&gt;&gt;

##### changeUserMfa()

```ts
changeUserMfa: (options?: RequestInit) =>
  Promise<FetchResponse<ErrorResponse | TotpGenerateResponse>>;
```
...
\| [`TotpGenerateResponse`](#totpgenerateresponse)&gt;&gt;
...
createPAT: (createPATRequest: CreatePATRequest, options?: RequestInit) =>
  Promise<FetchResponse<ErrorResponse | CreatePATResponse>>;
```
...
`Promise`&lt;[`FetchResponse`](#fetchresponse)&lt;[`JWKSet`](#jwkset)&gt;&gt;
...
`Promise`&lt;[`FetchResponse`](#fetchresponse)&lt;[`Session`](#session) \| [`ErrorResponse`](#errorresponse)&gt;&gt;
...
signInAnonymous: (
  ...
  options?: RequestInit,
) => Promise<FetchResponse<ErrorResponse | SessionPayload>>;
```
...
`Promise`&lt;[`FetchResponse`](#fetchresponse)&lt;[`ErrorResponse`](#errorresponse) \| [`SessionPayload`](#sessionpayload)&gt;&gt;
...
signInEmailPassword: (
  ...
  options?: RequestInit,
) => Promise<FetchResponse<ErrorResponse | SignInEmailPasswordResponse>>;
```
...
verifySignInOTPEmail: (
  ...
  options?: RequestInit,
) => Promise<FetchResponse<ErrorResponse | SignInOTPEmailVerifyResponse>>;
```
...
`Promise`&lt;[`FetchResponse`](#fetchresponse)&lt;
\| [`ErrorResponse`](#errorresponse)
\| [`SignInOTPEmailVerifyResponse`](#signinotpemailverifyresponse)&gt;&gt;
...
| Property                               | Type                                                    | Description                                                   |
| -------------------------------------- | ------------------------------------------------------- | ------------------------------------------------------------- |
| <a id="redirectto-2"></a> `redirectTo` | [`RedirectToQueryParameter`](#redirecttoqueryparameter) | Target URL for the redirect                                   |
