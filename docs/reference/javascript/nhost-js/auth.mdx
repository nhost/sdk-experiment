...
`Promise`&lt;[`FetchResponse`](#fetchresponse)&lt;[`TotpGenerateResponse`](#totpgenerateresponse)&gt;&gt;
...
`Promise`&lt;[`FetchResponse`](#fetchresponse)&lt;`"OK"`&gt;&gt;
...
`Promise`&lt;[`FetchResponse`](#fetchresponse)&lt;[`GetVersion200`](#getversion200)&gt;&gt;
...
`Promise`&lt;[`FetchResponse`](#fetchresponse)&lt;[`Session`](#session)&gt;&gt;
...
`Promise`&lt;[`FetchResponse`](#fetchresponse)&lt;[`SignInEmailPasswordResponse`](#signinemailpasswordresponse)&gt;&gt;
...
`Promise`&lt;[`FetchResponse`](#fetchresponse)&lt;[`SessionPayload`](#sessionpayload)&gt;&gt;
...
```ts
type LinkIdTokenRequest = object;
```
...
```ts
type MFAChallengePayload = object;
```
...
```ts
type RefreshTokenRequest = object;
```
...
```ts
type SigninAnonymousRequest = object;
```
...
```ts
type SignInEmailPasswordRequest = object;
```
...
```ts
type SignInEmailPasswordResponse = object;
```
...
```ts
type SignInIdTokenRequest = object;
```
...
```ts
type SignInMfaTotpRequest = object;
```
...
```ts
type SignInOTPEmailRequest = object;
```
...
```ts
type SignInOTPEmailVerifyRequest = object;
```
...
```ts
type SignInOTPEmailVerifyResponse = object;
```
...
```ts
type SignInPasswordlessEmailRequest = object;
```
...
```ts
type SignInWebauthnRequest = object;
```
...
```ts
type SignInWebauthnResponse = object;
```
...
```ts
type SignInWebauthnVerifyRequest = object;
```
...
```ts
type SignUpEmailPasswordRequest = object;
```
...
```ts
type SignUpWebauthnRequest = object;
```
...
```ts
type SignUpWebauthnResponse = object;
```
...
```ts
type SignUpWebauthnVerifyRequest = object;
```
...
```ts
type TotpGenerateResponse = object;
```
...
```ts
type UserDeanonymizeRequest = object;
```
...
```ts
type UserEmailChangeRequest = object;
```
...
```ts
type UserEmailSendVerificationEmailRequest = object;
```
...
```ts
type UserPasswordRequest = object;
```
...
```ts
type UserPasswordResetRequest = object;
```
