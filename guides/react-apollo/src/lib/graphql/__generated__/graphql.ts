...
export type GetNinjaTurtlesWithCommentsQuery = { __typename?: 'query_root', ninjaTurtles: Array<{ __typename?: 'ninjaTurtles', id: string, name: string, description?: string | null, createdAt: string, updatedAt: string, comments: Array<{ __typename?: 'comments', id: string, comment: string, createdAt: string, user: { __typename?: 'users', id: string, displayName: string, email?: string | null } }> }> };
 ...
 * });
 */
export function useGetNinjaTurtlesWithCommentsQuery(baseOptions?: Apollo.QueryHookOptions<GetNinjaTurtlesWithCommentsQuery, GetNinjaTurtlesWithCommentsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetNinjaTurtlesWithCommentsQuery, GetNinjaTurtlesWithCommentsQueryVariables>(GetNinjaTurtlesWithCommentsDocument, options);
      }
export function useGetNinjaTurtlesWithCommentsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetNinjaTurtlesWithCommentsQuery, GetNinjaTurtlesWithCommentsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetNinjaTurtlesWithCommentsQuery, GetNinjaTurtlesWithCommentsQueryVariables>(GetNinjaTurtlesWithCommentsDocument, options);
        }
export function useGetNinjaTurtlesWithCommentsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetNinjaTurtlesWithCommentsQuery, GetNinjaTurtlesWithCommentsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetNinjaTurtlesWithCommentsQuery, GetNinjaTurtlesWithCommentsQueryVariables>(GetNinjaTurtlesWithCommentsDocument, options);
        }
export type GetNinjaTurtlesWithCommentsQueryHookResult = ReturnType<typeof useGetNinjaTurtlesWithCommentsQuery>;
export type GetNinjaTurtlesWithCommentsLazyQueryHookResult = ReturnType<typeof useGetNinjaTurtlesWithCommentsLazyQuery>;
export type GetNinjaTurtlesWithCommentsSuspenseQueryHookResult = ReturnType<typeof useGetNinjaTurtlesWithCommentsSuspenseQuery>;
export type GetNinjaTurtlesWithCommentsQueryResult = Apollo.QueryResult<GetNinjaTurtlesWithCommentsQuery, GetNinjaTurtlesWithCommentsQueryVariables>;
